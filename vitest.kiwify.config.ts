...
export default defineConfig({
  test: {
    environment: "node",
    include: ["tests/invariants/kiwify*.test.ts", "tests/invariants/kiwify*.integration.ts", "tests/invariants/automation*.test.ts", "tests/invariants/webhooks-rls.test.ts"],
